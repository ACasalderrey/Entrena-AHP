/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareEnv --config wrangler.types.jsonc` (hash: 0373f1e04572944d99140e22a0695283)
